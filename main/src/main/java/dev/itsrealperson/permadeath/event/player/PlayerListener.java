package dev.itsrealperson.permadeath.event.player;
...
import dev.itsrealperson.permadeath.util.Utils;
        ...
        if (e.getAction().name().contains("RIGHT_CLICK") && item != null) {
            ...
            if (PermadeathItems.isAbyssalFilter(item)) {
                ...
                if (PermadeathItems.isAbyssalMask(p.getInventory().getHelmet())) {
                    ...
                    ItemStack[] acc = dev.itsrealperson.permadeath.util.inventory.AccessoryInventory.load(p);
                    if (acc != null) {
                ...
                if (mask != null && mask.getItemMeta() instanceof org.bukkit.inventory.meta.Damageable damageable) {
                    ...
                    if (isAccessory) {
                        ...
                        dev.itsrealperson.permadeath.util.inventory.AccessoryInventory.saveFromItems(p, acc);
                    } else {
            ...
            if (item.isSimilar(PermadeathItems.createAbyssalHeart())) {
                ...
                Bukkit.getOnlinePlayers().forEach(all -> {
                    ...
                    dev.itsrealperson.permadeath.util.AdvancementManager.grantAdvancement(all, dev.itsrealperson.permadeath.util.AdvancementManager.PDA.ABYSS_HEART);
                });
            }
        }
    }
    ...
    public void onPlayerDeath(PlayerDeathEvent e) {
        ...
        if (!isProtected[0] || forceDeathTrain) {
            ...
            if (Main.instance.getDay() >= 25) {
                ...
                // Disparar evento API
                Bukkit.getPluginManager().callEvent(new dev.itsrealperson.permadeath.api.event.DeathTrainEvent(Main.instance.getDeathTrainVersion(), true));
            }
