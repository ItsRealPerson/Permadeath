...
public class NMSAccessorImpl implements NMSAccessor {
    ...
    @Override
    public dev.itsrealperson.permadeath.api.entity.PermadeathEntity getCustomEntity(org.bukkit.entity.Entity entity) {
        ...
        if (plain.contains("Ultra Ravager")) {
            return new dev.itsrealperson.permadeath.nms.v1_21_R3.wrapper.UltraRavagerWrapper((org.bukkit.entity.Ravager) entity);
        }
        if (plain.contains("Warden Retorcido")) {
            return new dev.itsrealperson.permadeath.nms.v1_21_R3.wrapper.CustomWardenWrapper((org.bukkit.entity.Warden) entity);
        }
        if (plain.contains("Abyssal Creeper")) {
            return new dev.itsrealperson.permadeath.nms.v1_21_R3.wrapper.GenericEntityWrapper(le, "AbyssalCreeper");
        }
