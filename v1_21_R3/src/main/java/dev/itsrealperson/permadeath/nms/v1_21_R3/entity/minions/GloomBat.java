...
public class GloomBat {
    ...
    public static Bat spawn(Location loc, Plugin plugin) {
        ...
        bat.setCustomName("§8Explorador Sombrío");
        bat.setCustomNameVisible(true);

        EffectUtils.setMaxHealth(bat, 250.0); // Extremadamente difícil de matar para un murciélago
