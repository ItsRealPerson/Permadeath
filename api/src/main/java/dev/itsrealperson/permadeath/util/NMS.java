...
public class NMS {
     ...
     * Ejemplo: dev.itsrealperson.permadeath.nms.v1_21_R3.entity.DeathModuleImpl
     */
    ...
    public static String search(String rev, String classPath) {
        // Formato: dev.itsrealperson.permadeath.nms.v{VERSION}.{CLASE}
        return String.format("dev.itsrealperson.permadeath.nms.v%s.%s", rev, classPath);
    }
